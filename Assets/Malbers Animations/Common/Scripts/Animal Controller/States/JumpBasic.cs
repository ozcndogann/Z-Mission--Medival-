...
namespace MalbersAnimations.Controller
{
    public class JumpBasic : State
    {
        ...
        /// <summary>
        /// Only Activate the Multiple jump if the Input is False (meaning the Input was released )
        /// </summary>
        ...
        // public override bool TryActivate() => InputValue && (JumpsPerformanced < Jumps) && CanMultipleJump;
