...
namespace MalbersAnimations.Controller
{
    public class RagdollDeath : State
    {
        ...
        public bool EnablePreProcesing = true;
        ...
        public void Replace()
        {
           ...
           var AllJoints = ragdollInstance.GetComponentsInChildren<CharacterJoint>();
            ...
            var allMeshRendererRagdoll = ragdollInstance.GetComponentsInChildren<SkinnedMeshRenderer>();
            ...
            var allMeshRendererAnimal = animal.GetComponentsInChildren<SkinnedMeshRenderer>(false);
            ...
            //Move all renderers to the Ragdoll 
